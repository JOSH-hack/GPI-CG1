...
Nom du fichier   : EquipementReseauRequest.java
Objectif         : DTO de requête spécifique au matériel réseau
...
public class EquipementReseauRequest extends EquipementRequest {
