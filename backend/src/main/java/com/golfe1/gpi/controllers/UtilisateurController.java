...
public class UtilisateurController {
   ...
   // UTILITAIRE
// Recupere l'utilisateur connecte via le SecurityContext (peuple par JwtFilter,
// que le token vienne du cookie httpOnly ou d'un header Authorization) plutot
// que de reparser manuellement le header, qui n'existe plus depuis le passage
// au cookie httpOnly.
