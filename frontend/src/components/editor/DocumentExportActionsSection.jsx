...
const DocumentExportActionsSection = ({
  ...
  const confirmerExport = (nomFichier) => {
    ...
    onExport?.(format, nomFichier);
  };

  return (
    <Box component="footer" sx={{ display: "flex", alignItems: "center", flexWrap: "wrap", gap: 1.5, px: 3, py: 1.25, borderTop: 1, borderColor: "divider" }}>
      ...
      <Typography sx={{ fontFamily: "Inter, sans-serif", fontSize: 11.5, color: "#5c7078", mx: "auto", textAlign: "center" }}>
        {pageCount} pages · Dernière modification {lastEditedAt} par {lastEditedBy}
      </Typography>

      <Stack direction="row" spacing={1.5} alignItems="center">
        <Button size="small" onClick={onCancel} sx={{ fontSize: 12, fontWeight: 600, textTransform: "none", color: "#5c7078" }}>
          Annuler
        </Button>
        <Button
          size="small"
          ...
          sx={{ bgcolor: "#146f42", fontSize: 12, fontWeight: 700, textTransform: "none", "&:hover": { bgcolor: "#0f5732" } }}
        >
