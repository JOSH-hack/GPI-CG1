...
Nom du fichier   : Login.jsx
Objectif         : Page de connexion - meme identite visuelle que Register.jsx
                    (formes decoratives SVG, panneau vert, SpecularButton),
                    email + mot de passe uniquement, lien mot de passe oublie
...
const formFields = [
  ...
  { id: 'password', label: 'Mot De Passe', placeholder: 'au moins 6 caractères', type: 'password' },
]
    ...
    >
      ...
      >
        ...
        >
          ...
          <Stack direction="row" alignItems="center" spacing="7%" sx={{ mt: 'auto', pt: '7%' }}>
            <Box
              aria-hidden="true"
              sx={{
                display: 'grid',
            ...
            >
              ...
              >
                <Box sx={{ width: '62%', height: '68%', borderRadius: '50%', bgcolor: '#df0a0d' }} />
              </Box>
            </Box>
            <Typography
              sx={{
...
export default function Login() {
  ...
  function handleChange(event) {
    ...
    setFormValues((valeursActuelles) => ({ ...valeursActuelles, [name]: value }))
    ...
    >
      ...
      >
        ...
        >
          ...
          <Stack
            spacing={2}
            sx={{ display: { xs: 'flex', md: 'none' }, position: 'relative', zIndex: 1, mt: '10%', width: '100%' }}
          >
